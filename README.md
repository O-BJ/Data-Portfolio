...
## The Julia Part (2019)
The Julia part uploaded here mostly consists of visualizations and descriptive
...
a manual calculator and a few books, when I learnt many formulae by heart
(to get more feel for mathematics and statistics), and when I for the first
time used R before I quickly jumped ship to Julia, because of its speed.
...
freecodecamp, a short online university course, and personal practice.
I also used pen and paper a lot, because it was good to practice thinking
out database designs with, and to theoretically think out SQL code with it.
There was also a small reference book, whose conciseness and quick clarity
I preferred.

### Learning R
For learning R, I have mostly used online resources and books. Sometimes I
had to translate something I knew with Julia to R (whenever necessary). 
When I searched or search for information, knowing more or less what I
want, my searches usually are very specific.
